...
public class SowmitrasCompresser {
    ...
    public SowmitrasCompresser(Context context) {
        destinationDirectoryPath = context.getCacheDir().getPath() + File.separator + "images";
    }

    public SowmitrasCompresser setMaxWidth(int maxWidth) {
        this.maxWidth = maxWidth;
        return this;
    }

    public SowmitrasCompresser setMaxHeight(int maxHeight) {
        this.maxHeight = maxHeight;
        return this;
    }

    public SowmitrasCompresser setCompressFormat(Bitmap.CompressFormat compressFormat) {
        this.compressFormat = compressFormat;
        return this;
    }

    public SowmitrasCompresser setQuality(int quality) {
        this.quality = quality;
        return this;
    }

    public SowmitrasCompresser setDestinationDirectoryPath(String destinationDirectoryPath) {
